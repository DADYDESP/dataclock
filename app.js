...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function parseDate(dateValue) {
        ...
        const formats = [
            ...
            (str) => {
                ...
                // Flexibilidad: Si el día <= 12 y el mes > 12 (ej. 02/24/2025), asumimos MM/DD/YYYY
    ...
    function parseTime(timeValue) {
        ...
        // Convertir a string si no lo es y limpiar espacios en blanco (ej. "  99:99 ")
        const timeStr = String(timeValue).trim();
        
        // Si después de limpiar espacios el string queda vacío, no es una hora válida
